...
def is_prime(n):
    """Find out if n is a prime number or not.
    """
    if n == 0 or n == 1:
        return False
    divider = 2
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        ...
        current_roll = take_turn(num_rolls, opponent_score, select_dice(current_score, opponent_score))
        if current_roll == 0:
        ...
        if is_swap(current_score, opponent_score):
            ...
            opponent_score = i
        if who == 0:
            score0, score1 = current_score, opponent_score
        else:
            score1, score0 = current_score, opponent_score
        who = other(who)
    # END Question 5
...
def swap_strategy(score, opponent_score, num_rolls=5):
    ...
    if score + turn_score < opponent_score and is_swap(score + turn_score, opponent_score):
        return 0
    return num_rolls  # Replace this statement
    # END Question 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN Question 10
    margin = 6
    if score - opponent_score > 39:
        num_rolls = 3
    elif score - opponent_score > -23:
        num_rolls = 4
    ...
    if (score + opponent_score) % 7 == 0:
        return 1
    if 100 - score >= 12 and 100 - score <= 18:
        return 3
    return num_rolls  # Replace this statement
    # END Question 10
